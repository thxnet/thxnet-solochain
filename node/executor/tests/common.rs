...
pub fn compact_code_unwrap() -> &'static [u8] {
	thxnet_runtime::WASM_BINARY.expect(
...
pub const SPEC_VERSION: u32 = thxnet_runtime::VERSION.spec_version;

pub const TRANSACTION_VERSION: u32 = thxnet_runtime::VERSION.transaction_version;
